    ...
    class Program : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if (xDaBola < -ClientSize.Width / 2 )
            {
                xDaBola = 0;
                yDaBola = 0;
                placarDoJogador1 = placarDoJogador1 + 1;
            ...
            if (xDaBola > ClientSize.Width / 2)
            {
                xDaBola = 0;
                yDaBola = 0;
                placarDoJogador2 = placarDoJogador2 + 1;
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            DesenharRetangulo(xDaBola, yDaBola, tamanhoDaBola, tamanhoDaBola);
            DesenharRetangulo(xDoJogador1(), yDoJogador1, larguraDosJogadores(), alturaDosJogadores());
            DesenharRetangulo(xDoJogador2(), yDoJogador2, larguraDosJogadores(), alturaDosJogadores());
